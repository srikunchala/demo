 var app = angular.module('app', ['ngAnimate', 'ngTouch', 'ui.grid', 'ui.grid.edit', 'ui.grid.rowEdit','ui.grid.cellNav','ui.grid.pagination','ui.grid.resizeColumns', 'ui.grid.moveColumns']);
